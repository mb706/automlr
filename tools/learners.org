...
**** Variable Parameters:
   ...
   - oscar.c :: 0.. (0.1..10) exp: relative weighting of L_1 and L_inf norm for 'oscar' penalty
...
**** Variable Parameters:
   ...
   - minbucket :: int 1..#n/2# exp: min number of ob in leaf node {tree.m} req: stump == FALSE
...
**** Variable Parameters:
   ...
   - C :: 1e-10..0.9999999999: {tree.c} pruning confidence. req: U == FALSE && R == FALSE
...
**** Variable Parameters:
   - C :: 1e-10..0.9999999999: {tree.c} pruning confidence: req: R == FALSE && U == FALSE
   - M :: int 1..#n/2# exp: {tree.m} minimum instances per leaf
   - R :: TRUE, FALSE: {tree.r} reduced error pruning req: U == FALSE
...
**** Variable Parameters:
   ...
   - ntrees :: int 2.. (10..1000) exp: tree population size
...
**** Variable Parameters:
   - num.trees :: int 1.. (25..2000) exp: {rf.numtree} number of trees to grow
   - mtry :: int 1..#p# exp: number of sampled variables. {rf.features}
...
*** classif.dbnDNN
**** Variable Parameters:
   - numlayersidx :: int 1..4 : {nn.nlayer} DUMMY 
