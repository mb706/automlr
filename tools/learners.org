...
- INJECT: this is a variable that needs to be added to the learner
- {common id}
...
**** Variable Parameters:
   ...
   - C :: 0.1...9: {tree.c} pruning confidence. req: U == FALSE && R == FALSE
...
**** Variable Parameters:
   ...
   - epsilon :: .001...5 exp: insensitive loss epsilon. req: type %in% c("eps-svr", "nu-svr", "eps-bsvm")
