...
**** Variable Parameters:
   ...
   - maxsurrogate :: int 0.. (1..5): ONNA number of surrogate splits to evaluate. {tree.maxsurrogate}
...
**** Variable Parameters:
   ...
   - surrogatestyle :: 0, 1: ONNA how to calculate surrogate req: usesurrogate != 0
   - maxsurrogate :: int 0.. (1..5): ONNA number of surrogate splits to evaluate. {tree.maxsurrogate} req: usesurrogate != 0
...
**** Variable Parameters:
   ...
   - stump :: TRUE, FALSE: only one division
   - maxsurrogate :: int 0.. (1..5): ONNA number of surrogate splits to evaluate.
...
**** Variable Parameters:
   ...
   - usesurrogate :: 1, 2: ONNA how to use surrogate in splitting process {boost.usesurrogate}
   - surrogatestyle :: 0, 1: ONNA how to choose surrogates {boost.surrogatestyle}
   - maxsurrogate :: int 0.. (1..5): ONNA number of surrogate splits to evaluate. {boost.maxsurrogate} req: usesurrogate != 0
...
**** Variable Parameters:
   ...
   - maxsurrogate :: int 0.. (1..5): ONNA number of surrogate splits to evaluate. {boost.maxsurrogate}
...
**** Variable Parameters:
   ...
   - usesurrogate :: 1, 2: ONNA how to use surrogate in splitting process {boost.usesurrogate} req: Learner == 'tree'
   - maxsurrogate :: int 0.. (1..5): ONNA number of surrogate splits to evaluate. {boost.maxsurrogate} req: usesurrogate != 0 && Learner == 'tree'
   - surrogatestyle :: 0, 1: ONNA how to choose surrogates {boost.surrogatestyle} req: Learner == 'tree'
