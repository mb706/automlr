...
autowrappers = makeNamedAlList(
    autolearner(
        ...
        searchspace=list(
            ...
            sp("ppa.nzv.cutoff.factor", "real", c(1, 1), req=quote(automlr.remove.factors == TRUE)),
            sp("ppa.nzv.cutoff.factor.AMLRFIX1", "real", c(0, 1), req=quote(automlr.has.factors && !automlr.remove.factors)),
